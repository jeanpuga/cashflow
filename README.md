...
## Instalação
Para executar a aplicação Cashflow, é necessário que a máquina tenha o sistema operacional Windows, além de ter instalados o Docker, o Kubernetes e o Dotnet Core na Versão 6. Vale acentuar que a aplicação é toda multi-plataforma, porém devido a espaço em disco, não criei um .sh e por essa conta, não testei em ambiente Linux, "ainda". 
